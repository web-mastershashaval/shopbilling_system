...
<body>
    <div class="main">
        <section>
            ...
            <form id="signupForm" action="signup_hundler.php" method="POST" onsubmit="return validateForm()">
                <label for="name">Name:</label>
                <input type="text" id="name" name="name" required>

                <label for="contact">Contact:</label>
                <input type="number" placeholder="+254" id="contact" name="contact" required>
